...
# write.csv(top1result.df, file = "top1result_md_gen_highres_pos_BT500.csv")

## If only data analysis from top1result dataframe shall be done, active lower command line.

# top1result.df<- read.csv(text=getURL("https://raw.github.com/Pohnert-Lab/SC-MS-Identification/master/Identification_results/Datafile_S5.csv", .opts=curlOptions(followlocation = TRUE))) # URL S5
...
# postscript("ROC_Scores_md_gen_pos.eps", width = 8, height = 8)
...
# postscript("ROC_BT_md_gen_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_md_Cos_gen_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_md_Eu_gen_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_md_iEu_gen_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_md_BT_Cos_gen_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_md_BT_Eu_gen_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_md_BT_iEu_gen_pos.eps", width = 8, height = 8)
...
for (i in c("cos","eu","ieu")){
  ...
  # ggsave(filename = paste0("confmat_md_gen_pos_",i,".eps"),device = "eps", width = 20, height = 20, units = "cm")
