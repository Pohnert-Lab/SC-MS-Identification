...
# write.csv(top1result.df, file = "top1result_csd_sp_integer_pos_BT500.csv")

## If only data analysis from top1result dataframe shall be done, active lower command line.

# top1result.df<- read.csv(text=getURL("https://raw.github.com/Pohnert-Lab/SC-MS-Identification/master/Identification_results/Datafile_S9.csv", .opts=curlOptions(followlocation = TRUE))) # URL S9
...
# postscript("ROC_Scores_csd_sp_int_pos.eps", width = 8, height = 8)
...
# postscript("ROC_BT_sp_int_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_Cos_sp_int_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_Eu_sp_int_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_iEu_sp_int_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_BT_Cos_sp_int_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_BT_Eu_sp_int_pos.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_BT_iEu_sp_int_pos.eps", width = 8, height = 8)
...
for (i in c("cos","eu","ieu")){
  ...
  plot (p)
   ...
   # ggsave(filename = paste0("confmat_csd_sp_int_pos_",i,".eps"),device = "eps", width = 20, height = 20, units = "cm")
