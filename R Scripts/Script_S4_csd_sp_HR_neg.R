...
# write.csv(top1result.df, file = "top1result_csd_sp_highres_neg_BT500.csv")

## If only data analysis from top1result dataframe shall be done, active lower command line.

# top1result.df<- read.csv(text=getURL("https://raw.github.com/Pohnert-Lab/SC-MS-Identification/master/Identification_results/Datasfile_S4.csv", .opts=curlOptions(followlocation = TRUE))) # URL S4
...
# postscript("ROC_Scores_csd_sp_neg.eps", width = 8, height = 8)
...
# postscript("ROC_BT_sp_neg.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_Cos_sp_neg.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_Eu_sp_neg.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_iEu_sp_neg.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_BT_Cos_sp_neg.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_BT_Eu_sp_neg.eps", width = 8, height = 8)
...
# postscript("SensErr_csd_BT_iEu_sp_neg.eps", width = 8, height = 8)
...
for (i in c("cos","eu","ieu")){
  ...
  plot (p)
   ...
   # ggsave(filename = paste0("confmat_csd_sp_neg_",i,".eps"),device = "eps", width = 20, height = 20, units = "cm")
