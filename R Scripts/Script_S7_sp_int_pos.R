...
# write.csv(top1result.df, file = "top1result_species_integer_positive_BT500.csv")

## If only data analysis from top1result dataframe shall be done, active lower command line.

# top1result.df<- read.csv(text=getURL("https://raw.github.com/Pohnert-Lab/SC-MS-Identification/master/Identification_results/Dataset_S7.csv", .opts=curlOptions(followlocation = TRUE))) # URL S7
...
# postscript("ROC_Scores_sp_int_positive.eps", width = 8, height = 8)
...
# postscript("ROC_BT_sp_int_positive.eps", width = 8, height = 8)
...
# postscript("SensErr_Cos_sp_int_positive.eps", width = 8, height = 8)
...
# postscript("SensErr_Eu_sp_int_positive.eps", width = 8, height = 8)
...
# postscript("SensErr_iEu_sp_int_positive.eps", width = 8, height = 8)
...
# postscript("SensErr_BT_Cos_sp_int_positive.eps", width = 8, height = 8)
...
# postscript("SensErr_BT_Eu_sp_int_positive.eps", width = 8, height = 8)
...
# postscript("SensErr_BT_iEu_sp_int_positive.eps", width = 8, height = 8)
...
for (i in c("cos","eu","ieu")){
  ...
  plot (p)
   ...
   # ggsave(filename = paste0("confmat_positive_int_",i,".eps"),device = "eps", width = 20, height = 20, units = "cm")
