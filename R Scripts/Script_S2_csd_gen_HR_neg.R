...
# write.csv(top1result.df, file = "top1result_csd_gen_highres_neg_BT500.csv")

## If only data analysis from top1result dataframe shall be done, activate lower command line.

# top1result.df<- read.csv(text=getURL("https://raw.github.com/Pohnert-Lab/SC-MS-Identification/master/Identification_results/Datafile_S2.csv", .opts=curlOptions(followlocation = TRUE))) # URL S2
...
# postscript("ROC_Scores_csd_gen_neg.eps", width = 8, height = 8)
...
# postscript("ROC_BT_csd_gen_neg.eps", width = 8, height = 8)
...
# postscript("ErrSens_csd_Cos_gen_neg.eps", width = 8, height = 8)
...
# postscript("ErrSens_csd_Eu_gen_neg.eps", width = 8, height = 8)
...
# postscript("ErrSens_csd_iEu_gen_neg.eps", width = 8, height = 8)
...
# postscript("ErrSens_csd_BT_Cos_gen_neg.eps", width = 8, height = 8)
...
# postscript("ErrSens_csd_BT_Eu_gen_neg.eps", width = 8, height = 8)
...
# postscript("ErrSens_csd_BT_iEu_gen_neg.eps", width = 8, height = 8)
...
for (i in c("cos","eu","ieu")){
  ...
  # ggsave(filename = paste0("confmat_csd_gen_neg_",i,".eps"),device = "eps", width = 20, height = 20, units = "cm")
